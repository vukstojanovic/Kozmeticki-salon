...
export default function EditDeleteCategory({ name, id }: Categories) {
    ...
    return (
        <Flex justifyContent="space-between" m='auto' w='2xl' bg='gray.200' marginBottom='15px' marginTop='15px'>
            ...
            >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <form
                            onSubmit={handleSubmit((data) => updateCategory({ data, id }))}
                        >
                            <Flex>
                                <Input
                                    border="none"
                    ...
                    <ModalBody>
                        <Box>
                            ...
                            <Flex justifyContent='flex-end' marginTop='20px'>
                                <Button onClick={onDeleteCategoryClose} fontWeight='normal'>Cancel</Button>
                                <Button
